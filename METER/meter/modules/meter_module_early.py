...
class METERTransformerSS(pl.LightningModule):
    def __init__(self, 
                 config,
                 trainable=["classifier", "pooler", "token_type_embeddings", "rank_output"] + ['PA'] + ['EE']
                ):
        super().__init__()
        ...
        self.EE_mlp_text = nn.Linear(768, 768)
        self.EE_mlp_image = nn.Linear(768, 768)
    ...
    def infer(
        ...
        text_feats, image_feats = self.EE_mlp_text(x), self.EE_mlp_image(y)
