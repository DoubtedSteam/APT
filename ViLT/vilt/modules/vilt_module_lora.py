...
import vilt.modules.vision_transformer_lora as vit
...
class ViLTransformerSS(pl.LightningModule):
    def __init__(self, 
                 config, 
                 trainable=["classifier", "pooler", "token_type_embeddings", "rank_output"] + ["lora"]
                ):
        super().__init__()
        ...
        extra_param = sum(p.numel() for n, p in self.named_parameters() if "lora" in n)
